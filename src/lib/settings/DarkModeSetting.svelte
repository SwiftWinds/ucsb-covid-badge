<script lang="ts">
  ...
  import { theme, Theme } from "../stores.ts";
...
<style lang="postcss">
  :global([data-theme="dark"] [setting="dark-mode"]) {
    --icon-color: invert(66%) sepia(61%) saturate(201%) hue-rotate(193deg)
      brightness(155%) contrast(98%);
    --icon-bg-color: #3a3e84;
  }

  :global([data-theme="light"] [setting="dark-mode"]) {
    --icon-color: invert(27%) sepia(100%) saturate(5879%) hue-rotate(250deg)
